(function () {
    ...
    function colorBySlug(slug) {
        ...
        return match.length ? match[0].color : '#59332A';
    }
    ...
    function placeholderIcon(size) {
        ...
        return el('svg', {
            ...
            stroke:      'currentColor',
            strokeWidth: '1.5',
            style: { width: iconSize + 'px', height: iconSize + 'px', opacity: '0.45' },
        },
            el('path', {
                strokeLinecap:  'round',
    ...
    registerBlockType('celya/icon-card', {
        edit: function (props) {
            ...
            var inspectorControls = el(InspectorControls, null,
                ...
                el(PanelBody, { title: 'Fond coloré', initialOpen: true },
            ...
            return el('div', null, inspectorControls, preview);
        },
